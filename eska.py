# -*- coding: utf-8 -*-
#THIS TOOL WAS CREATED IN INDONESIA BY @eskaproid (Telegram)
#I'M NOT RESPONSIBLE FOR ANY CAUSE
#THINK TWICE BEFORE ATTACKING ANY SITE SPECIALLY .gov & .edu
#24/04/2025
...
def menu():
    ...
    stdout.write("             "+Fore.LIGHTRED_EX            +"╔═════════════════════════════════════════════════════╗\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"l7       "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" List Layer7 Methods                    "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"l4       "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" List Layer4 Methods                    "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"tools    "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" List tools                             "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Channel  "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Show Telegram Channel                  "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Exit ESKSA69 DDoS                      "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using ESKA69.              "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"BRO 𓃠    "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" YOU GAY :V                          "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║                                                     "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ═══════════════════════════════════════\n")
    stdout.write("\n")
##############################################################################################
def Channel():
    stdout.write(" "+Fore.RED +"════════════════════════╗\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189m@ESKA69\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Channel   "+Fore.RED+": \x1b[38;2;0;255;189m@vibranixioid\n")
    stdout.write(" "+Fore.RED +"════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
    clear()
    stdout.write("        "+Fore.RED   +"                               ,-.                               \n")
    stdout.write("        "+Fore.RED   +"          ___,---.__          /'|`\          __,---,___          \n")
    stdout.write("        "+Fore.RED   +"       ,-'    \`    `-.____,-'  |  `-.____,-'    //    `-.       \n")
    stdout.write("        "+Fore.RED   +"     ,'        |           ~'\     /`~           |        `.     \n")
    stdout.write("        "+Fore.RED   +"    /      ___//              `. ,'          ,  , \___      \    \n")
    stdout.write("        "+Fore.RED   +"   |    ,-'   `-.__   _         |        ,    __,-'   `-.    |   \n")
    stdout.write("        "+Fore.RED   +"   |   /          /\_  `   .    |    ,      _/\          \   |   \n")
    stdout.write("        "+Fore.RED   +"   \  |           \ \`-.___ \   |   / ___,-'/ /           |  /   \n")
    stdout.write("        "+Fore.RED   +"    \  \           | `._   `\\  |  //'   _,' |           /  /    \n")
    stdout.write("        "+Fore.RED   +"     `-.\         /'  _ `---'' , . ``---' _  `\         /,-'     \n")
    stdout.write("        "+Fore.RED   +"        ``       /     \    ,='/ \`=.    /     \       ''        \n")
    stdout.write("        "+Fore.RED   +"                |__   /|\_,--.,-.--,--._/|\   __|                \n")
    stdout.write("        "+Fore.RED   +"                /  `./  \\`\ |  |  | /,//' \,'  \                \n")
    stdout.write("        "+Fore.RED   +"               /   /     ||--+--|--+-/-|     \   \               \n")
    stdout.write("        "+Fore.RED   +"              |   |     /'\_\_\ | /_/_/`\     |   |              \n")  
    stdout.write("        "+Fore.RED   +"               \   \__, \_     `~'     _/ .__/   /               \n")
    stdout.write("        "+Fore.RED   +"                `-._,-'   `-._______,-'   `-._,-'                \n")             
    stdout.write("                                "+Fore.RED  +"┬  ┌─┐┬ ┬┌─┐┬─┐ ══╗     \n")
    stdout.write("                                "+Fore.RED  +"│  ├─┤└┬┘├┤ ├┬┘  ╔╝     \n")
    stdout.write("                                "+Fore.RED  +"┴─┘┴ ┴ ┴ └─┘┴└─  ╩      \n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ═══════════════════════════════════════\n")
    ...
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"CFREQ  "+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" Bypass CF UAM, CAPTCHA, BFM (request)    "+Fore.LIGHTRED_EX+"║\n")
    ...
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"PXSKY  "+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" Bypass Google Project Shield, Vshield,   "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m  "+Fore.LIGHTWHITE_EX+"       "+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" DDoS Guard Free, CF NoSec With Proxy     "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"SKY    "+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" Sky method without proxy                 "+Fore.LIGHTRED_EX+"║\n")
    ...
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"PXHTTP2"+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" HTTP 2.0 Request Attack With Proxy       "+Fore.LIGHTRED_EX+"║\n")
    ...
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"PPS    "+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" Only GET / HTTP/1.1                      "+Fore.LIGHTRED_EX+"║\n")
    ...
    stdout.write("            "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"PXSPOOF"+Fore.LIGHTRED_EX+" |"+Fore.LIGHTWHITE_EX+" HTTP Spoof Socket Attack With Proxy      "+Fore.LIGHTRED_EX+"║\n")
...
def layer4():
    ...
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"tcp   "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" TCP Attack                                "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╚═════════════════════════════════════════════════════╝\n") 
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ═══════════════════════════════════════\n")
    stdout.write("\n")
##############################################################################################
...
def title():
    stdout.write(" "+Fore.RED+"              .                                                      .                         \n")
    stdout.write(" "+Fore.RED+"           .n                   .                 .                  n.                        \n")
    stdout.write(" "+Fore.RED+"     .   .dP                  dP                   9b                 9b.    .                 \n")
    stdout.write(" "+Fore.RED+"    4    qXb         .       dX                     Xb       .        dXp     t                \n")
    stdout.write(" "+Fore.RED+"   dX.    9Xb      .dXb    __                         __    dXb.     dXP     .Xb               \n")
    stdout.write(" "+Fore.RED+"   9XXb._       _.dXXXXb dXXXXbo.                 .odXXXXb dXXXXb._       _.dXXP               \n")
    stdout.write(" "+Fore.RED+"    9XXXXXXXXXXXXXXXXXXXVXXXXXXXXOo.           .oOXXXXXXXXVXXXXXXXXXXXXXXXXXXXP                \n")
    stdout.write(" "+Fore.RED+"     `9XXXXXXXXXXXXXXXXXXXXX'~   ~`OOO8b   d8OOO'~   ~`XXXXXXXXXXXXXXXXXXXXXP'                 \n")
    stdout.write(" "+Fore.RED+"       `9XXXXXXXXXXXP' `9XX'  skibid  `98v8P'  toilet  `XXP' `9XXXXXXXXXXXP'                   \n")
    stdout.write(" "+Fore.RED+"           ~~~~~~~       9X.          .db|db.          .XP       ~~~~~~~                       \n")
    stdout.write(" "+Fore.RED+"                           )b.  .dbo.dP'`v'`9b.odb.  .dX(                                      \n")
    stdout.write(" "+Fore.RED+"                         ,dXXXXXXXXXXXb     dXXXXXXXXXXXb.                                     \n")
    stdout.write(" "+Fore.RED+"                        dXXXXXXXXXXXP'   .   `9XXXXXXXXXXXb                                    \n")
    stdout.write(" "+Fore.RED+"                       dXXXXXXXXXXXXb   d|b   dXXXXXXXXXXXXb                                   \n")
    stdout.write(" "+Fore.RED+"                       9XXb'   `XXXXXb.dX|Xb.dXXXXX'   `dXXP                                   \n")
    stdout.write(" "+Fore.RED+"                       `'       9XXXXXX(   )XXXXXXP     `'                                     \n")
    stdout.write(" "+Fore.RED+"                                 XXXX X.`v'.X XXXX                                             \n")
    stdout.write(" "+Fore.RED+"                                 XP^X'`b   d'`X^XX                                             \n")
    stdout.write(" "+Fore.RED+"                                 X. 9  `   '  P )X                                             \n")
    stdout.write(" "+Fore.RED+"                                 `b  `       '  d'                                             \n")
    stdout.write(" "+Fore.RED+"                                  `             '                                              \n")
    stdout.write("                                "+Fore.RED    +"╭━━━┳━━━┳╮╭━┳━━━┳━━━┳━━━╮         \n")
    stdout.write("                                "+Fore.RED    +"┃╭━━┫╭━╮┃┃┃╭┫╭━╮┃╭━━┫╭━╮┃      \n")
    stdout.write("                                "+Fore.RED    +"┃╰━━┫╰━━┫╰╯╯┃┃╱┃┃╰━━┫╰━╯┃       \n")
    ...
    stdout.write("               "+Fore.LIGHTRED_EX+"        ═══════════════════════════════════════\n")
    stdout.write("               "+Fore.LIGHTRED_EX+"╔═════════════════════════════════════════════════════╗\n")
    stdout.write("               "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To The Main Screen Of ESKA69  "+Fore.LIGHTRED_EX  +"     ║\n")
    stdout.write("               "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Type [menu] to see the Commands    "+Fore.LIGHTRED_EX +"       ║\n")
    stdout.write("               "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"     Contact Developer - Telegram @eskaproid "+Fore.LIGHTRED_EX +"      ║\n")
    stdout.write("               "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +"               -Develop In Indonesia-        "+Fore.LIGHTRED_EX +"        ║\n") 
    stdout.write("               "+Fore.LIGHTRED_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("               "+Fore.LIGHTRED_EX+"        ═════════════════════════════════════\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTRED_EX+">"+Fore.LIGHTRED_EX+"[""root"+Fore.WHITE+"@"+Fore.LIGHTRED_EX+"Eska69"+Fore.RED+"]\x1b[38;2;255;20;147m~ "+Fore.WHITE)
    command = input()
...
##############################################################################################     
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE+"Unknown command. type 'menu' to see all commands.\n")  
##############################################################################################   
...
#    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"stellar    "+Fore.RED+": "+Fore.WHITE+"HTTPS Sky method without proxies\n")
    ...
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"Channel    "+Fore.RED+": "+Fore.WHITE+"Thanks for\n")
